...
class Egany_FB_Group_To_WP_Admin {
    ...
    function admin_menu() {
        add_submenu_page( 'edit.php?post_type=egany_fb2wp_post', __( 'Facebook to WordPress Importer', 'EGANY' ), __( 'Settings', 'EGANY' ), 'manage_options', 'egany_fb2wp-settings', array( $this, 'settings_page' ) );
    }
